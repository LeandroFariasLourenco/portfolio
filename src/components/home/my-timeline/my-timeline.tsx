...
const MyTimeline = () => {
    ...
    return (
      ...
      >
        <div className={styles[`my-timeline-row-${landmark.position}`]}>
          ...
          <div className={`${styles['my-timeline-row-card']} ${styles[landmark.position]}`} style={{ boxShadow: `0 0 3px ${background}` }}>
            <div className={styles['my-timeline-row-card-details']}>
              <h3><FormattedMessage id={landmark.name} /></h3>
              <h3 className={`${styles['my-timeline-row-card-date']} ${styles[landmark.position]}`}
                style={{ textShadow: `${background} 0 0 5px` }}>
                {intl.formatMessage({ id: landmark.date })}
              </h3>
            </div>
            <p className={styles["my-timeline-row-card-text"]}><FormattedMessage id={landmark.description} /></p>
          </div>
        </div>
        {
  ...
  return (
    <div className={styles['my-timeline-container']}>
      <Section
